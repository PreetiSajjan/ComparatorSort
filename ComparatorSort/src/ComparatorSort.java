...
public class ComparatorSort<T>{
	 ...
	 */
	public List<T> sort(List<T> strarray, Comparator<T> C) { 
		comparator = C;
		array = strarray;
...
{ 
    public static void main (String[] args) {
    	//Creating an object of the class ComparatorSort for type String and Double
    	ComparatorSort<String> string_obj = new ComparatorSort<String>();
        ComparatorSort<Double> double_obj = new ComparatorSort<Double>();
        
        List SortedArray = null;
        
        //Creating an comparator instance for type String as CString
    	Comparator<String> CString=new Comparator<String>() {
            public int compare(String o1, String o2) {
                return o1.compareTo(o2);
            }
        };
        
      //Creating an comparator instance for type Double as CDouble
    	Comparator<Double> CDouble=new Comparator<Double>() {
		...
		if((n1 >= 16 ) && ((n1&(n1-1)) == 0)) { 			
			...
			System.out.println("Sorted Array of type Double: " + SortedArray);
		}
		else
			System.out.println("Array length restrictions: Size of array should be in powers of 2 with atleast 16 elements in it.");
